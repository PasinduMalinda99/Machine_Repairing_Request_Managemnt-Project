    ...
    <div class="container article-clean">
        <div class="row">
            <div class="col">
                ...
                <form action="{{ route('admin/admin_add_products_store') }}" method="POST" enctype="multipart/form-data" class="bootstrap-form-with-validation" style="padding-top: 25px;">
                    @csrf

                    <h1 class="text-right" style="margin-bottom: 10px;">Add Products</h1>
                    <p class="text-right">Just update your new product details here</p>
                    <div class="form-group"><label for="text-input">Product Name :</label><input class="form-control" type="text" id="product_name" name="product_name" required=""></div>
                    <div class="form-group"><label for="textarea-input">Product Card View Description :</label><textarea class="form-control" id="product_view_description" name="product_view_description" required=""></textarea></div>
                    <div class="form-group"><label for="textarea-input">Product Details :</label><textarea class="form-control" id="product_details" name="product_details" required=""></textarea></div>
                    <div class="form-group"><label for="textarea-input">Product Features :</label><textarea class="form-control" id="product_features" name="product_features" required="" rows="5"></textarea></div>
                    <div class="form-group"><label for="file-input">Add Product Image :</label><input class="form-control-file" type="file" id="product_image" name="product_image" required=""></div>
                    <div class="form-group" style="text-align: right;">
                        <button class="btn btn-primary" type="reset" style="text-align: right;margin-right: 5px;margin-left: 5px;">Clear Form</button>
                        <button class="btn btn-primary" type="submit" style="text-align: right;margin-right: 5px;margin-left: 5px;">Add Product</button>
                    </div>
                </form>
