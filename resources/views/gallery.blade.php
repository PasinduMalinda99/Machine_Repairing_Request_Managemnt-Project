        ...
        <div class="container-fluid"><a class="navbar-brand d-flex align-items-center" href="{{url('index')}}"><span class="bs-icon-sm bs-icon-rounded bs-icon-primary d-flex justify-content-center align-items-center me-2 bs-icon"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-bezier">
            ...
            <div class="collapse navbar-collapse" id="navcol-2">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="{{url('gallery')}}">Gallery</a></li>
        ...
        <div class="container">
            <div class="row mb-5">
                <div class="col-md-8 col-xl-6 text-center mx-auto">
                    <h2><span style="color: rgb(0, 0, 0);">RMS Technologies</span></h2>
                    <p class="w-lg-50">Do Any Kinds Electronic Job With Technological Strategies &amp; Competence.</p>
                </div>
            </div>
            <div class="row gx-2 gy-2 row-cols-1 row-cols-sm-4 photos" data-bss-baguettebox="">
                @foreach($gallary as $gallary)
                <div class="col item"><a href="/gallary/{{$gallary->image}}"><img class="img-fluid" src="/gallary/{{$gallary->image}}"></a></div>
                @endforeach
            </div>
        </div>
    </section>
