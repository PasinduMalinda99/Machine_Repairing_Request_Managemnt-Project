...
<body>
    <ul class="nav flex-column shadow d-flex sidebar mobile-hid">
        ...
        <li class="nav-item"><a class="nav-link active text-left text-white py-1 px-0" href="{{url('user/user_profile')}}"><i class="fas fa-user mx-3"></i><span class="text-nowrap mx-2">User profile</span></a></li>
            ...
            <div class="col">
                <div>
                    <div class="col" style="margin-top: 22px;padding-top: 1px;">
                        <h2 class="text-left" style="text-align: center;margin-bottom: 0px;padding-top: 20px;">User Profile</h2>
                        <p class="text-left" style="text-align: center;padding-top: 30px;font-size: 17px;filter: blur(0px);">Hello, You are the valuable user of RMS Technologies.</p>
                    </div>
                                ...
                                <div class="row no-gutters">
                                    <div class="col-md-6" style="background: #ffffff;">
                                        <div class="text-white p-4 p-md-5">
                                            <h4 class="font-weight-bold text-center text-white mb-3">&nbsp; &nbsp;</h4>

                                            <form method="POST" enctype="multipart/form-data" action="">

                                            <p class="mb-4" style="color: rgb(0,0,0);">Name :&nbsp; {{ auth()->user()->name }}</p>
                                            <p class="mb-4" style="color: rgb(0,0,0);">User ID :&nbsp; rms_user_id_{{ auth()->user()->id }}</p>
                                            <p class="mb-4" style="color: rgb(0,0,0);">Mobile Number :&nbsp; {{ auth()->user()->mobile_number }}</p>
                                            <p class="mb-4" style="color: rgb(0,0,0);">Email :&nbsp; {{ auth()->user()->email }}</p>

                                            </form>

                                        </div>
                                    </div>
                                    <div class="col-md-6 order-first order-md-last" style="min-height: 250px;"><img class="w-100 h-100 fit-cover" src="{{ asset("img/user_pic1.jpg")}}"></div>
                                </div>
                            </div>
                        </div>
                    </section>
