...
<body>
    <ul class="nav flex-column shadow d-flex sidebar mobile-hid">
        ...
        <li class="nav-item"><a class="nav-link active text-left text-white py-1 px-0" href="{{url('user/user_index')}}"><i class="fas fa-tachometer-alt mx-3"></i><span class="text-nowrap mx-2">Dashboard</span></a></li>
    ...
    <div class="container article-clean">
        <div class="row">
            <div class="col">
                <div>
                    <div class="col" style="margin-top: 22px;padding-top: 1px;">
                        <h1 style="text-align: center;">Welcome to RMS Technologies</h1>
                        <p style="text-align: center;padding-top: 20px;font-size: 17px;filter: blur(0px);">Hey, welcome back!&nbsp;Your RMS Technologies dashboard keeps everything in one place. Track your repair progress,&nbsp;and even browse services for future needs. Need to tell us something? Leave feedback in a snap! We're here to make your repairs a breeze.</p>
                    </div>
                    <section class="py-4 py-xl-5">
                        <div class="container">
                            <div class="border rounded d-flex flex-column justify-content-center align-items-center p-4 py-5" style="background: linear-gradient(rgba(0,123,255,0.2), rgba(0,123,255,0.2)), url({{ asset("img/rms_user.jpg")}}) center / cover;height: 500px;">
                                <div class="row">
                                    <div class="col-md-10 col-xl-8 text-center d-flex d-sm-flex d-md-flex justify-content-center align-items-center mx-auto justify-content-md-start align-items-md-center justify-content-xl-center">
                                        <div>
                                            <h1 class="font-weight-bold mb-3"><strong>Need a Repair?<br>Submit a Request Now!</strong></h1>
                                            <p class="mb-4">"Is your printing machine or electronic device in need of repair? Submit your repair request, and our expert technicians will handle it quickly and efficiently!"</p>
                                            <a class="btn btn-outline-primary fs-5 py-2 px-4" role="button" href="{{url('user/user_request')}}" style="margin-top: 3px; margin-bottom: 3px; margin-left: 3px; margin-right: 3px;">Submit Request</a>
                                            <a class="btn btn-outline-primary fs-5 py-2 px-4" role="button" href="{{ route('user/user_view_request') }}" style="margin-top: 3px; margin-bottom: 3px; margin-left: 3px; margin-right: 3px;">View Sent Request</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
