            ...
            <div class="col">
                <div>
                    <div class="col" style="margin-top: 25px;padding-top: 1px;">
                        <h2 class="text-left" style="text-align: center;">List of Products</h2>
                    ...
                    @endif
                        ...
                        <div class="text-right" style="margin-bottom: 15px;margin-right: 15px;"><a class="btn btn-primary" role="button" href="{{route('admin/admin_add_products')}}">Add Product</a></div>
                    </div>
                        ...
                        <div class="table-responsive table table-hover table-bordered results">
                            <table class="table table-hover table-bordered">
                                <thead class="bill-header cs">
                                    <tr>
                                        <th id="trs-hd-1" class="col-lg-1">Product Count</th>
                                        <th id="trs-hd-2" class="col-lg-2">Product ID</th>
                                        <th id="trs-hd-3" class="col-lg-3">Product Name</th>
                                        <th id="trs-hd-4" class="col-lg-2">Product Status</th>
                                        <th id="trs-hd-5" class="col-lg-2">Product Image</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;">product_id_{{ str_pad($pp->id, 2, '0', STR_PAD_LEFT) }}</td>
                                        <td style="text-align: center;">{{ $pp->product_name }}</td>
                                        <td style="text-align: center;">Brand New</td>
                                        <td>

                                            @if($pp->product_image)
                                                <img src="{{ asset('product_images/' . $pp->product_image) }}" alt="{{ $pp->product_name }} Image" style="width: 155px; height: 95px;">
                                            @else
                                                No Image Available
                                            @endif
                                        ...
                                        <td style="text-align: center;">
                                                ...
                                                <a href="{{ url('admin/admin_view_product/' . $pp->id) }}" class="btn btn-primary" type="submit" style="margin-left: 3px;margin-bottom: 3px;margin-right: 3px;margin-top: 3px;"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-eye-fill" style="font-size: 15px;">
                                                    <path d="M10.5 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0z"></path>
                                                    <path d="M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8zm8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7z"></path>
                                                </svg></a>

                                                <a href="{{ url('admin/admin_edit_products/' . $pp->id) }}"  onclick="return confirm('Do you want to edit product?');" class="btn btn-success" style="margin-left: 3px;margin-bottom: 3px;margin-right: 3px;margin-top: 3px;" type="submit"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-pencil-square" style="font-size: 15px;">
                                                    <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"></path>
                                                    <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"></path>
                                                </svg></a>

                                                <form action="{{ route('admin/admin_update_products_delete', $pp->id) }}" method="POST" type="button" class="btn btn-danger p-0" onsubmit="return confirm('Do you want to delete the Product ?')">
                                                    @csrf
                                                    @method('DELETE')

                                                    <button class="btn btn-danger" style="margin-left: 3px;margin-bottom: 3px;margin-right: 3px;margin-top: 3px;" type="submit"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-trash3-fill" style="font-size: 15px;">
