...
<body>
    <ul class="nav flex-column shadow d-flex sidebar mobile-hid">
        ...
        <li class="nav-item"><a class="nav-link active text-left text-white py-1 px-0" href="{{url('admin/admin_index')}}"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-speedometer mx-3">
            ...
            <div class="col">
                <div>
                    <div class="col" style="margin-top: 25px; padding-top: 1px;">
                        <h2 style="text-align: center;">RMS Tech Admin</h2>
                    </div>

                    <section>
                        <div class="container" style="margin-bottom: 40px; margin-top: -5px;">
                          <div class="row d-flex justify-content-center">
                            <canvas id="myChart" style="width:100%;max-width:600px;"></canvas>
                          </div>
                          <p style="text-align: center; padding-top: 5px; padding-bottom: 5px; font-size: 15px; filter: blur(0px);">Summary of Repair Request Status</p>
                        </div>
                      </section>

                      <script>
                        var xValues = ["Pending", "Accepte", "Rejecte", "On Repair", "Job Complete"];
                        var yValues = [{{ $pendingRequest }}, {{ $acceptedRequest }}, {{ $rejectedRequest }}, {{ $repairingRequest }}, {{ $completeRequest }}];
                        var barColors = ["#87CEFA", "#4169E1", "#FF0000", "#FFD700", "#228B22"];
                                ...
                                <div class="card shadow border-start-success py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col me-2">
                                                <div class="text-uppercase text-success fw-bold text-xs mb-1"><span>All Users Count</span></div>
                                                <div class="text-dark fw-bold h5 mb-0"><span>{{ $totalUser }}</span></div>
                                            </div>
                                            <div class="col-auto"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-person-check-fill fa-2x text-gray-300">
                            ...
                            <div class="col-md-6 col-xl-3 mb-4">
                                <div class="card shadow border-start-success py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col me-2">
                                                <div class="text-uppercase text-success fw-bold text-xs mb-1"><span>Today Request Count</span></div>
                                                <div class="text-dark fw-bold h5 mb-0"><span>{{ $todayRequest }}</span></div>
                                            </div>
                                            <div class="col-auto"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-chat-text-fill fa-2x text-gray-300">
                            ...
                            <div class="col-md-6 col-xl-3 mb-4">
                                <div class="card shadow border-start-success py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col me-2">
                                                <div class="text-uppercase text-success fw-bold text-xs mb-1"><span>All Request Count</span></div>
                                                <div class="text-dark fw-bold h5 mb-0"><span>{{ $totalRequest }}</span></div>
                                            </div>
                                            <div class="col-auto"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-clipboard-check-fill fa-2x text-gray-300">
                            ...
                            <div class="col-md-6 col-xl-3 mb-4">
                                <div class="card shadow border-start-success py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col me-2">
                                                <div class="text-uppercase text-success fw-bold text-xs mb-1"><span>Pending Request</span></div>
                                                <div class="text-dark fw-bold h5 mb-0"><span>{{ $pendingRequest }}</span></div>
                                            </div>
                                            <div class="col-auto"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-envelope-open-fill fa-2x text-gray-300">
                            ...
                            <div class="col-md-6 col-xl-3 mb-4">
                                <div class="card shadow border-start-success py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col me-2">
                                                <div class="text-uppercase text-success fw-bold text-xs mb-1"><span>Accepted Request</span></div>
                                                <div class="text-dark fw-bold h5 mb-0"><span>{{ $acceptedRequest }}</span></div>
                                            </div>
                                            <div class="col-auto"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-envelope-check-fill fa-2x text-gray-300">
                            ...
                            <div class="col-md-6 col-xl-3 mb-4">
                                <div class="card shadow border-start-success py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col me-2">
                                                <div class="text-uppercase text-success fw-bold text-xs mb-1"><span>Rejected Request</span></div>
                                                <div class="text-dark fw-bold h5 mb-0"><span>{{ $rejectedRequest }}</span></div>
                                            </div>
                                            <div class="col-auto"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-trash3-fill fa-2x text-gray-300">
                            ...
                            <div class="col-md-6 col-xl-3 mb-4">
                                <div class="card shadow border-start-success py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col me-2">
                                                <div class="text-uppercase text-success fw-bold text-xs mb-1"><span>On Repair Process</span></div>
                                                <div class="text-dark fw-bold h5 mb-0"><span>{{ $repairingRequest }}</span></div>
                                            </div>
                            ...
                            <div class="col-md-6 col-xl-3 mb-4">
                                <div class="card shadow border-start-success py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col me-2">
                                                <div class="text-uppercase text-success fw-bold text-xs mb-1"><span>Completed job</span></div>
                                                <div class="text-dark fw-bold h5 mb-0"><span>{{ $completeRequest }}</span></div>
                                            </div>
                                            <div class="col-auto"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-bag-check-fill fa-2x text-gray-300">
                ...
                <section class="py-4 py-xl-5" style="margin-top: -30px;">
                    <div class="container h-100">
                        <div class="text-white bg-primary border rounded border-primary p-4 py-5" data-bss-hover-animate="pulse" style="background: radial-gradient(var(--blue) 25%, rgba(14,27,36,0.32) 100%);">
                            <div class="row h-100">
                                <div class="col-md-10 col-xl-8 text-center d-flex d-sm-flex d-md-flex justify-content-center align-items-center mx-auto justify-content-md-start align-items-md-center justify-content-xl-center">
                                    <div>
                                        <h1 class="font-weight-bold mb-3">Check Personal Email Now!</h1>
                                        <p class="mb-4">Direct connect with your email to check if you have any Email</p><a class="btn btn-outline-light btn-lg py-2 px-4" role="button" href="https://mail.google.com/" target="_blank">Check Mail</a>
                                    </div>
                                </div>
                            </div>
                        </div>
