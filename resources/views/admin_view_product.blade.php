...
<head>
    ...
    <link rel="stylesheet" href="{{ asset("admin/css/aos.min.css")}}">
...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-5" style="margin-top: 35px;">
                ...
                <div>
                    <p>Get in Touch for Purchasing Inquiries Regarding This Machine.</p>
                    <div class="d-flex align-items-center p-3" data-aos="zoom-in-up"><a class="social-link" href="tel:+94 77 7281060" style="margin: 0px 5px;"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-telephone-outbound-fill social-link-icon">
                    ...
                    <div class="d-flex align-items-center p-3" data-aos="zoom-in-up"><a class="social-link" href="mailto:rmstech2000@gmail.com" style="margin: 0px 5px;"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-chat-text-fill social-link-icon">
                    ...
                    <div class="d-flex align-items-center p-3" data-aos="zoom-in-up"><a class="social-link" href="https://www.facebook.com/rmstechnologies/" target="_blank" style="margin: 0px 5px;"> <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-facebook social-link-icon">
                                <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"></path>
                            </svg>
                            <div class="social-link-effect"></div>
                        </a>
                        <div class="px-2">
                            <h6 class="font-weight-bold mb-0">Facebook</h6>
                            <p class="mb-0"><span style="color: rgba(33, 37, 41, 0.75);">RMS Technologies</span></p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <h4 style="margin-bottom: 16px;margin-top: 5px;">Machine Details</h4>
                <p>{{ $product->product_details }}</p>
            </div>
            <div class="col-md-6">
                <h4 style="margin-bottom: 16px;margin-top: 5px;">Machine Features</h4>
    ...
    <script src="{{ asset("admin/js/aos.min.js")}}"></script>
