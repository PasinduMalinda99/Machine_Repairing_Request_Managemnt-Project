            ...
            <div class="col">
                <div>
                    <div class="col" style="margin-top: 22px;padding-top: 1px;">
                        <h2 class="text-right" style="text-align: center;margin-top: 20px;">User Repair Request Details</h2>
                        <p class="text-right" style="text-align: center;padding-top: 16px;font-size: 17px;filter: blur(0px);margin-bottom: 0px;">Hello admin, I am waiting to receive your service.<br><br></p>
                    </div>
                </div>
            </div>
        </div>
