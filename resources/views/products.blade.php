...
<head>
    ...
    <link rel="stylesheet" href="{{ asset("css/css/styleProducts.css")}}">
...
<body>
    ...
    <div></div>
    <div class="container h-100" style="margin-bottom: -25px; margin-top: 5px;">
            ...
            @foreach ($product as $product)
                <div class="col-md-3">  <div class="card border">
                    ...
                    @if(isset($product) && $product->product_image)
                        <img class="card-img-top w-100 d-block" src="/product_images/{{ $product->product_image }}">
                    @else
                    ...
                    <a href="{{ route('view_products', $product->id) }}" class="btn btn-primary">View Product</a>
                    </div>
                </div>
                </div>
