...
<body>
    ...
    <div class="carousel slide" data-bs-ride="carousel" id="carousel-1" style="margin: 20px;">
        <div class="carousel-inner">
            <div class="carousel-item active"><img class="w-100 d-block" src="{{ asset("img/1%20Slide.jpg")}}" alt="Slide Image"></div>
            <div class="carousel-item"><img class="w-100 d-block" src="{{ asset("img/2%20Slide.jpg")}}" alt="Slide Image"></div>
            <div class="carousel-item"><img class="w-100 d-block" src="{{ asset("img/3%20Slide.jpg")}}" alt="Slide Image"></div>
        </div>
    ...
    <h1 class="text-center" style="height: 60.5px;">RMS Technologies (Pvt) Ltd<br><br></h1>
    <h5 class="text-center" style="height: 35px;">Do Any Kinds Electronic Job With Technological Strategies &amp; Competence.</h5>
