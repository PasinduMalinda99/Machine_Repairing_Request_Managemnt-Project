...
<body>
            ...
            <div class="col">
                <div>
                    <div class="col" style="margin-top: 22px;padding-top: 1px;">
                        <h2 class="text-right" style="text-align: center;margin-top: 20px;">View the Sent Request and Status</h2>
                        <p class="text-right" style="text-align: center;padding-top: 16px;font-size: 17px;filter: blur(0px);margin-bottom: 0px;">

                            Hello! Your Request :

                                @if($repair_requests->status == 'Pending')

                                    <span style="color:rgb(170, 0, 186)"><b>Pending</b></span>

                                @endif

                                @if($repair_requests->status == 'Accepted')

                                    <span style="color:rgb(52, 103, 255)"><b>Accepted</b></span>

                                @endif

                                @if($repair_requests->status == 'Rejected')

                                    <span style="color:rgb(255, 82, 52)"><b>Rejected</b></span>

                                @endif

                                @if($repair_requests->status == 'On Repair Process')

                                    <span style="color:rgb(240, 200, 0)"><b>On Repair Process</b></span>

                                @endif

                                @if($repair_requests->status == 'Job Completed')
    ...
    <div style="padding: 10px;">
        <div class="container py-4 py-xl-5" style="box-shadow: inset 0px 0px 1px 2px #455dc7;">
            <div class="row row-cols-1 row-cols-md-2">
                <div class="col mb-4">
                    <div class="d-flex flex-column flex-lg-row">
                        <div class="py-4 py-lg-0 px-lg-4">
                            <h4 class="font-weight-bold"><span style="font-weight: normal !important;">Email Address :</span></h4>
                            <p><br>↪&nbsp;{{ $repair_requests->email }}</p>
                        </div>
                    </div>
                </div>
                <div class="col mb-4">
                    <div class="d-flex flex-column flex-lg-row">
                        <div class="py-4 py-lg-0 px-lg-4">
                            <h4 class="font-weight-bold"><span style="font-weight: normal !important;">Mobile Number :</span></h4>
                            <p><br>↪&nbsp;{{ $repair_requests->mobile_number }}</p>
                        </div>
                    </div>
                </div>
                <div class="col mb-4">
                    <div class="d-flex flex-column flex-lg-row">
                        <div class="py-4 py-lg-0 px-lg-4">
                            <h4 class="font-weight-bold"><span style="font-weight: normal !important;">Device Type :</span></h4>
                            <p><br>↪&nbsp;{{ $repair_requests->device_type }}</p>
                        </div>
                    </div>
                </div>
                <div class="col mb-4">
                    <div class="d-flex flex-column flex-lg-row">
                        <div class="py-4 py-lg-0 px-lg-4">
                            <h4 class="font-weight-bold"><span style="font-weight: normal !important;">Device Information :</span></h4>
                            <p><br>↪&nbsp;{{ $repair_requests->device_information }}</p>
                        </div>
                    </div>
                </div>
                <div class="col mb-4">
                    <div class="d-flex flex-column flex-lg-row">
                        <div class="py-4 py-lg-0 px-lg-4">
                            <h4 class="font-weight-bold"><span style="font-weight: normal !important;">Issue Description :</span></h4>
                            <p><br>↪&nbsp;{{ $repair_requests->issue_description }}</p>
                        </div>
                    </div>
                </div>
                <div class="col mb-4">
                    <div class="d-flex flex-column flex-lg-row">
                        <div class="py-4 py-lg-0 px-lg-4">
                            <h4 class="font-weight-bold"><span style="font-weight: normal !important;">Additional Details :</span></h4>
                            <p><br>↪&nbsp;{{ $repair_requests->additional_details }}</p>
                        </div>
                    </div>
                </div>
            </div>
