...
<body>
    ...
    <nav class="navbar navbar-expand-md shadow-sm py-3">
        <div class="container-fluid"><a class="navbar-brand d-flex align-items-center" href="{{url('index')}}"><span class="bs-icon-sm bs-icon-rounded bs-icon-primary d-flex justify-content-center align-items-center me-2 bs-icon"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-bezier">
            ...
            <div class="collapse navbar-collapse" id="navcol-2">
                ...
                </ul><a class="btn btn-outline-primary ms-md-2" role="button" href="{{url('sign_up')}}" style="margin: 1px;" target="_parent">SIGN UP</a><a class="btn btn-primary active ms-md-2" role="button" href="{{url('sign_in')}}" style="margin: 1px;" target="_parent">SIGN IN</a>
            </div>
        </div>
    </nav>
    ...
    <div class="container h-100">
        <div class="col-md-10 col-lg-11 col-xl-8 text-center d-flex d-sm-flex d-md-flex justify-content-center align-items-center mx-auto justify-content-md-start align-items-md-center justify-content-xl-center">
            <div>
                <h2 class="text-uppercase fw-bold mb-3"><br>Welcome to RMS Technologies</h2>
                <p class="mb-4">Sign in to your account to access our powerful repair service management platform.</p>
            </div>
        </div>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="card mb-5">
                        <div class="card-body d-flex flex-column align-items-center">
                            ...
                            <form class="text-center" method="POST" action="{{route("sign_in.action")}}">
                                @csrf
                                <!--<div class="mb-3"><input class="form-control" type="text" placeholder="Username" name="username" id="username" required=""></div>-->
                                ...
                                <div class="mb-3"><input class="form-control" type="password" name="password" id="password" placeholder="Password" required="" minlength="8"></div>
                                <div class="mb-3"><button class="btn btn-primary d-block w-100" type="submit">Login</button></div>
                                <p class="text-muted">Don't have an account<span style="color: rgb(119, 119, 119);">?&nbsp;</span><a href="{{url('sign_up')}}" target="_parent">Sign Up</a></p>
                                <p class="text-muted" style="align-content: center"><span style="color: rgb(119, 119, 119);"></span><a href="{{url('forgot_password')}}" target="_parent">Forgot Password?</a></p>
                            </form>
                        </div>
                    </div>
                </div>
