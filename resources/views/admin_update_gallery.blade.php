...
<body>
    <ul class="nav flex-column shadow d-flex sidebar mobile-hid">
        ...
        <li class="nav-item"><a class="nav-link active text-left text-white py-1 px-0" href="{{url('admin/admin_update_gallery')}}"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-images mx-3">
            ...
            <div class="col">
                <div>
                    <div class="col" style="margin-top: 22px;padding-top: 1px;">
                        <h2 class="text-center" style="text-align: center;margin-bottom: 0px;">Upload New Images to Gallery</h2>
                        <p class="text-center" style="text-align: center;padding-top: 16px;font-size: 17px;filter: blur(0px);margin-bottom: 20px;">Upload only images in .jpg format here. You can delete the added images if you want.</p>
                    </div>
                </div><div class="bootstrap_img_upload">
<div class="container py-5">
    ...
    <div class="row py-4">
        <div class="col-lg-6 mx-auto">
            ...
            <form action="{{url('admin/admin_upload_gallery')}}" method="Post" enctype="multipart/form-data">

                @csrf

                <div class="input-group mb-3 px-2 py-2 rounded-pill bg-white shadow-sm">
                    <input id="upload" type="file" name="image" onchange="readURL(this);" class="form-control border-0" required>
                    <label id="upload-label" for="upload" class="font-weight-light text-muted">Only upload photos under 2MB</label>
            ...
            <!-- Uploaded image area-->
            <p class="font-italic text-white text-center"><br/>The image uploaded will be rendered inside the box below.</p>
        ...
        <div class="row">
            ...
            @foreach($gallary as $gallary)
                ...
                <div class="col-md-3 col-sm-6 col-12 mb-3">
                    ...
                    <img class="img-fluid" src="/gallary/{{$gallary->image}}">

                    <a onclick="return confirm('Are you sure to delete the image?');" style="margin-top: 15px;" class="btn btn-danger" href="{{ url('admin/delete_admin_upload_gallery',$gallary->id) }}">Delete Image <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-trash" style="font-size: 15px;">
