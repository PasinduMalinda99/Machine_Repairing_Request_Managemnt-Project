            ...
            <div class="col">
                <div>
                    <div class="col" style="margin-top: 22px;padding-top: 1px;">
                        <h2 class="text-left" style="text-align: center;margin-top: 20px;">User Details</h2>
                        <p class="text-left" style="text-align: center;padding-top: 16px;font-size: 17px;filter: blur(0px);margin-bottom: 0px;">Hello Admin, I'm user from RMS Technologies.<br><br></p>
                    </div>
                </div>
                    ...
                    <div class="container">
                        <div class="bg-dark border rounded border-dark overflow-hidden">
                            <div class="row no-gutters">
                                <div class="col-md-6" style="background: #0056b1;">
                                    <div class="text-white p-4 p-md-5">
                                        <h5 class="font-weight-bold text-center text-white mb-3">&nbsp; &nbsp; &nbsp;&nbsp;</h5>
                                        <p class="mb-4">Name :&nbsp;{{ $users->name }}</p>
                                        <p class="mb-4">User ID :&nbsp;rms_user_id_{{ $users->id }}</p>
                                        <p class="mb-4">Mobile Number :&nbsp;{{ $users->mobile_number }}</p>
                                        <p class="mb-4">Email:&nbsp;{{ $users->email }}</p>
                                    </div>
                                </div>
                                <div class="col-md-6 order-first order-md-last" style="min-height: 250px;"><img class="w-100 h-100 fit-cover" src="{{ asset("img/user_pic.jpg")}}"></div>
                            </div>
                        </div>
                    </div>
                </section>
