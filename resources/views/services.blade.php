...
<head>
    ...
    <link rel="stylesheet" href="{{ asset("css/css/styleServices.css")}}">
    <link rel="stylesheet" href="{{ asset("css/css/styleServices.min.css")}}">
...
<body>
    ...
    <div class="wrapper">
        <div class="content-box">
            <div class="card" style="height: 290px;"><i class="bx bx-laptop bx-md"></i>
                <h2>Repiar All Printing Machine</h2>
                <p>Repairing printing machine and any kind of printing related machinery &amp; equipments</p>
            </div>
            <div class="card" style="height: 290px;"><i class="bx bx-bar-chart-alt bx-md"></i>
                <h2>Repairing Cricket Bowling Machine</h2>
                <p>Repairing cricket bowling machine of Sri Lanka Cricket Board and Schools( BOLA &amp; etc.)</p>
            </div>
            <div class="card" style="height: 290px;"><i class="bx bx-line-chart bx-md"></i>
                <h2>Innovations</h2>
                <p>Introducing new electronic systems with PIC &amp; micro controllers for polar and wohlenberg cutters and other printing machines</p>
            </div>
            <div class="card" style="height: 290px;"><i class="bx bx-paint bx-md"></i>
                <h2>The only "AutoPrint" agency in Sri Lanka</h2>
                <p>Importers and Distributors all AutoPrint Products and Spear Parts.</p>
            </div>
            <div class="card" style="height: 290px;"><i class="bx bx-bar-chart bx-md"></i>
                <h2>Take a part of servicing of other importers</h2>
                <p>Take a part of servicing of major printing machine importers</p>
            </div>
            <div class="card" style="height: 290px;"><i class="bx bx-mail-send bx-md"></i>
                <h2>Do any kinds of Electronic Job</h2>
                <p>Repair professional audio &amp; video equipments, High power amplifiers, audio &amp; video mixtures, Cameras &amp; video conference units etc.</p>
            </div>
        </div>
    </div>
    <hr>
