...
<body>
    <ul class="nav flex-column shadow d-flex sidebar mobile-hid">
        ...
        <li class="nav-item"><a class="nav-link active text-left text-white py-1 px-0" href="{{url('admin/admin_manage_user')}}"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-person-fill-check mx-3">
            ...
            <div class="col">
                <div>
                    <div class="col" style="margin-top: 25px;padding-top: 1px;">
                        <h2 class="text-left" style="text-align: center;">List of System Users</h2>
                    </div>
                        ...
                        <div class="table-responsive table table-hover table-bordered results">
                            <table class="table table-hover table-bordered">
                                <thead class="bill-header cs">
                                    <tr>
                                        <th id="trs-hd-1" class="col-lg-1">Users Count</th>
                                        <th id="trs-hd-2" class="col-lg-2">User ID</th>
                                        <th id="trs-hd-3" class="col-lg-2">User Name</th>
                                        <th id="trs-hd-4" class="col-lg-2">Mobile Number</th>
                                        <th id="trs-hd-5" class="col-lg-2">Joined Date</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;">rms_user_{{ str_pad($user->id, 2, '0', STR_PAD_LEFT) }}</td>
                                        <td>{{ $user->name }}</td>
                                        <td style="text-align: center;">{{ $user->mobile_number }}</td>
                                        <td style="text-align: center;">{{ $user->created_at->format('Y-m-d') }}</td>
                                        <td style="text-align: center;">

                                            <a class="btn btn-primary" role="button" style="margin-left: 3px;margin-bottom: 3px;margin-right: 3px;margin-top: 3px;" href="{{ url('admin/admin_manage_user_view/' . $user->id) }}"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-eye-fill" style="font-size: 15px;">
                                            <path d="M10.5 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0z"></path>
                                            <path d="M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8zm8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7z"></path>
                                        </svg></a>

                                        <form action="{{ route('admin/admin_manage_user_delete', $user->id) }}" method="POST" type="button" class="btn btn-danger p-0" onsubmit="return confirm('Delete User Profile?')">
                                            @csrf
                                            @method('DELETE')
